...
export function Body() {
    return (
        <div>
            <LeadingImageRow clName={"stepImageAppScreen"} image={appScreen} primary={"Buy daily needs to specialty items"} secondary={"You find merchants fulfilling your everyday groceries to occassional hand crafts."} />
            <TrailingImageRow clName={"stepImageUPI"} image={upiImage} primary={"Pay Online"} secondary={"No more hassle of keeping change! Pay online with Gpay, PhonePE, Paytm or any of your favorite UPI app."} />
            <Infocard />
            <Carousel/>
            <DownloadAppCard />
        </div>
    ...
    return (
        <div className="d-flex rowSpace">
            ...
            <div className="d-flex flex-column justify-content-center col-lg-4 col-med-12 col-sm-12">
                <p dangerouslySetInnerHTML={{ __html: props.primary }} className="primaryText" />
                <p dangerouslySetInnerHTML={{ __html: props.secondary }} className="secondaryText" />
            </div>
        ...
        <div className="infoCard rowSpace">
            <div className="d-flex infoCard-content">
                ...
                <div className="d-flex flex-column justify-content-center col-lg-6 col-sm-12 col-med-12">
                    ...
                    <p className="secondaryText mt-3">We respect your privacy. We are also humans on the other side and we seriosuly have no intention to know what are you doing. We are busy working to make your shopping experience better.</p>
                </div>
            </div>
        </div>
    );
...
function DownloadAppCard() {
    return (
        <div className="downloadAppCard largeRowSpace" style={{ backgroundImage: `url(${botigaBackground})`}}>
